...
/**
 * Full-viewport animated dot pattern background.
 *
 * Notes:
 * - This project doesn't use Tailwind, so the component is styled via inline styles.
 * - The container uses `pointerEvents: "none"` so it won't block clicks.
 * - Mouse position is tracked from `window` events.
 */
...
export default function Background(props: DotPatternProps) {
